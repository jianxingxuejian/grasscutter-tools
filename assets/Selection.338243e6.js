import{d as oe,r as c,ab as ft,_ as ne,Y as re,h as r,by as vt,t as L,a as l,v as a,w as Q,b as M,u as Z,A as U,bS as pt,g as A,X as V,z as gt,i as wt,bT as mt,F as xt,k as N,b4 as ee}from"./index.ee7aa6e2.js";import{N as Ct}from"./Input.b1e04abb.js";import{_ as Y}from"./Tag.865ce6e1.js";import{e as yt,f as $t,b as _t}from"./Tooltip.7d0f1436.js";import{u as Ft}from"./utils.14ba8262.js";function Rt(e){switch(typeof e){case"string":return e||void 0;case"number":return String(e);default:return}}const P="v-hidden",Tt=$t("[v-hidden]",{display:"none!important"}),te=oe({name:"Overflow",props:{getCounter:Function,getTail:Function,updateCounter:Function,onUpdateOverflow:Function},setup(e,{slots:z}){const b=c(null),u=c(null);function C(){const{value:w}=b,{getCounter:n,getTail:R}=e;let s;if(n!==void 0?s=n():s=u.value,!w||!s)return;s.hasAttribute(P)&&s.removeAttribute(P);const{children:m}=w,f=w.offsetWidth,v=[],p=z.tail?R==null?void 0:R():null;let x=p?p.offsetWidth:0,T=!1;const y=w.children.length-(z.tail?1:0);for(let i=0;i<y-1;++i){if(i<0)continue;const $=m[i];if(T){$.hasAttribute(P)||$.setAttribute(P,"");continue}else $.hasAttribute(P)&&$.removeAttribute(P);const I=$.offsetWidth;if(x+=I,v[i]=I,x>f){const{updateCounter:O}=e;for(let _=i;_>=0;--_){const S=y-1-_;O!==void 0?O(S):s.textContent=`${S}`;const E=s.offsetWidth;if(x-=v[_],x+E<=f||_===0){T=!0,i=_-1,p&&(i===-1?(p.style.maxWidth=`${f-E}px`,p.style.boxSizing="border-box"):p.style.maxWidth="");break}}}}const{onUpdateOverflow:h}=e;T?h!==void 0&&h(!0):(h!==void 0&&h(!1),s.setAttribute(P,""))}const F=ft();return Tt.mount({id:"vueuc/overflow",head:!0,anchorMetaName:yt,ssr:F}),ne(C),{selfRef:b,counterRef:u,sync:C}},render(){const{$slots:e}=this;return re(this.sync),r("div",{class:"v-overflow",ref:"selfRef"},[vt(e,"default"),e.counter?e.counter():r("span",{style:{display:"inline-block"},ref:"counterRef"}),e.tail?e.tail():null])}}),zt=L([l("base-selection",`
 position: relative;
 z-index: auto;
 box-shadow: none;
 width: 100%;
