import{t as Q,a as F,b$ as _n,b as X,d as U,e as mn,u as sn,g as N,i as fn,h as C,bd as gn,T as vn,c9 as xn,b9 as wn,ae as bn,C as q,D as z,E as d,V as on,H,G as Z,r as $,a3 as an,M as W,J as v,I as r,bg as M,K as e,bs as R,ca as cn,cb as O,b3 as L,cc as yn,cd as $n,bD as D,z as kn,af as qn,ce as Cn,b5 as jn,cf as Sn,cg as Mn}from"./index.e7727c1e.js";import{a as zn,_ as Bn}from"./MyButton.vuevuetypescriptsetuptruelang.3298f837.js";import{_ as In}from"./ServerInput.vuevuetypescriptsetuptruelang.d7ac5119.js";import{r as E,s as Fn,_ as Pn,i as An,a as Y,p as nn,b as tn}from"./SelectFile.vuevuetypescriptsetuptruelang.213ff431.js";import{_ as Tn}from"./Checkbox.615310ce.js";import{_ as Un}from"./plugin-vueexport-helper.2444895f.js";import{a as Zn}from"./Tooltip.4a300f9d.js";import{_ as rn}from"./Space.8ed2780b.js";import{_ as Ln}from"./Tag.8d0e7954.js";import{a as Vn}from"./Switch.853c41d0.js";import"./request.4471139f.js";import"./Dropdown.b63e829e.js";import"./utils.b9679391.js";import"./ChevronRight.9e472838.js";import"./InputGroupLabel.adba5f6b.js";import"./get-slot.8207e825.js";function Hn(s,o){const t=[];let i=0;for(const n of s.split(`
...
[1.4.3]: https://github.com/jianxingxuejian/grasscutter-tools/compare/v1.4.2...v1.4.3
[1.4.2]: https://github.com/jianxingxuejian/grasscutter-tools/releases/tag/v1.4.2
`,St={class:"flex-col items-center"},Mt={class:"text-8"},zt=d("div",{id:"content"},null,-1),Bt=U({__name:"Changelog",setup(s,{expose:o}){o({open:h});const{t}=H(),i=Z(),n=$(!1);function h(){n.value=!0,an(()=>{const a=document.getElementById("content");if(!a)return;let l;i.locale==="zh-CN"?l=Ct:l=jt,a.innerHTML=V(Hn(l))})}return(a,l)=>{const u=cn,_=O;return q(),W(_,{show:e(n),"onUpdate:show":l[0]||(l[0]=f=>R(n)?n.value=f:null),class:"w-40% of-auto"},{default:v(()=>[r(u,{class:"h-80vh"},{default:v(()=>[d("div",St,[d("div",Mt,M(e(t)("changelog")),1),zt])]),_:1})]),_:1},8,["show"])}}});const It={class:"flex-col items-center gap-y-5"},Ft={class:"flex-center w-full"},Pt={class:"flex-center w-full"},At={class:"flex-center w-full"},Tt=U({__name:"StartupItems",setup(s,{expose:o}){o({show:k,launcherAll:j});const{t}=H(),i=Z(),{launcher:n,mod:h,updateGamePath:a,updateModPath:l,updateAkebiPath:u,updateLauncher:_}=i,f=$(!1);function k(){f.value=!0}const x=()=>b(a),w=()=>b(l),g=()=>b(u);async function b(S){const c=await Fn();c&&await S(c)}async function j(){var S;try{const c=h.path;c&&n.modStart&&await E(c);const p=n.akebiPath;if(p&&n.akebiStart)await E(p);else{const m=n.gamePath;m&&n.gameStart&&await E(m)}}catch(c){(S=window.$message)==null||S.error(c)}}return(S,c)=>{const p=Tn,m=Pn,B=O;return q(),W(B,{show:e(f),"onUpdate:show":c[3]||(c[3]=y=>R(f)?f.value=y:null),preset:"card",title:e(t)("startup items"),"auto-focus":!1,class:"w-70%"},{default:v(()=>[d("div",It,[d("div",Ft,[r(p,{checked:e(n).gameStart,"onUpdate:checked":[c[0]||(c[0]=y=>e(n).gameStart=y),e(_)],class:"w-7 mr-4"},null,8,["checked","onUpdate:checked"]),r(m,{value:e(n).gamePath,"button-text":e(t)("select"),placeholder:e(t)("select game"),onClick:x},null,8,["value","button-text","placeholder"])]),d("div",Pt,[r(p,{checked:e(n).modStart,"onUpdate:checked":[c[1]||(c[1]=y=>e(n).modStart=y),e(_)],class:"w-7 mr-4"},null,8,["checked","onUpdate:checked"]),r(m,{value:e(h).path,"button-text":e(t)("select"),placeholder:e(t)("select 3dm"),onClick:w},null,8,["value","button-text","placeholder"])]),d("div",At,[r(p,{checked:e(n).akebiStart,"onUpdate:checked":[c[2]||(c[2]=y=>e(n).akebiStart=y),e(_)],class:"w-7 mr-4"},null,8,["checked","onUpdate:checked"]),r(m,{value:e(n).akebiPath,"button-text":e(t)("select"),placeholder:e(t)("select akebi"),onClick:g},null,8,["value","button-text","placeholder"])])])]),_:1},8,["show","title"])}}});const Ut=Un(Tt,[["__scopeId","data-v-e60a3e73"]]),Zt={class:"flex-col items-center"},Lt={class:"text-5"},Vt=d("div",{id:"content"},null,-1),Ht=U({__name:"Updater",setup(s,{expose:o}){o({open:a});const{t}=H(),i=$(!1),n=$(!1);async function h(){var l,u;try{i.value=!0,await yn(),(l=window.$dialog)==null||l.success({title:t("install successful"),content:t("whether relaunch"),negativeText:t("cancel"),positiveText:t("relaunch"),onPositiveClick:()=>$n()})}catch(_){(u=window.$notification)==null||u.error({title:t("failed to update"),description:`error: ${_}`,content:t("try again")})}finally{i.value=!1}}function a(l){!l||(n.value=!0,an(()=>{const u=document.getElementById("content");!u||(u.innerHTML=V(l))}))}return(l,u)=>{const _=D,f=rn,k=Dn,x=cn,w=O;return q(),W(w,{show:e(n),"onUpdate:show":u[1]||(u[1]=g=>R(n)?n.value=g:null),"mask-closable":!1,class:"w-50%"},{default:v(()=>[r(x,null,{default:v(()=>[r(k,{show:e(i)},{default:v(()=>[d("div",Zt,[d("div",Lt,M(e(t)("new ver discover")),1),Vt,r(f,{class:"flex-center mt-4"},{default:v(()=>[r(_,{onClick:u[0]||(u[0]=g=>n.value=!1)},{default:v(()=>[L(M(e(t)("cancel")),1)]),_:1}),r(_,{type:"success",onClick:h},{default:v(()=>[L(M(e(t)("update")),1)]),_:1})]),_:1})])]),_:1},8,["show"])]),_:1})]),_:1},8,["show"])}}});const Rt={class:"flex-col px-10 gap-y-4"},Nt={class:"flex items-center"},Et={class:"text-8"},Dt={class:"flex-center grow"},Wt=d("span",{class:"text-8 flex-center"},"Grasscutter-Tools",-1),Ot={class:"ml-auto flex text-8 gap-x-2"},Gt={class:"flex-center"},Jt={class:"flex"},Kt={class:"text-5 mr-2"},Qt={class:"flex"},Xt={class:"text-5 mr-2"},Yt={class:"flex-center"},fe=U({__name:"index",setup(s){const{t:o}=H(),t=$(""),i=$(!1),n=$(),h=Z(),{updateCheckTime:a,getServer:l}=Z(),u=$(),_=$(),f=$();async function k(){var c,p;try{const m=await An();(c=window.$message)==null||c.success(m)}catch(m){(p=window.$message)==null||p.error(m)}}const x=$("8080"),w=$(!1);function g(c){if(!/^\d+$/.test(c))return!1;const p=Number(c);return p>0&&p<=65535}async function b(c){var p;try{c?(await Y(l),await nn(x.value),w.value=!0):(await tn(),w.value=!1)}catch(m){(p=window.$message)==null||p.error(m)}}async function j(){var c;await Y(l),await nn(x.value),w.value=!0,(c=_.value)==null||c.launcherAll()}async function S(c){var B,y;const p=Date.now(),m=h.update.lastCheckTime;if(c||!m||m&&m+216e5<p)try{const{shouldUpdate:P,manifest:I}=await Mn();P&&(I==null?void 0:I.body)?(n.value=JSON.parse(I.body)[h.locale],i.value=!0):(B=window.$message)==null||B.success(o("latest ver now"))}catch(P){(y=window.$notification)==null||y.error({title:o("failed get update info"),description:`error: ${P}`,content:o("retry manually")})}finally{a(p)}}return kn(()=>{var c;if(i.value){const p=(c=window.$notification)==null?void 0:c.info({title:o("new ver discover"),content:o("whether upgrade"),action:()=>C(D,{text:!0,type:"primary",onClick:()=>{var m;p==null||p.destroy(),(m=u.value)==null||m.open(n.value)}},{default:()=>o("confirm")})})}}),qn(async()=>t.value=await Cn()),jn(async()=>S()),Sn(window,"beforeunload",()=>{w.value&&tn()}),(c,p)=>{var K;const m=kt,B=Ln,y=vt,P=ht,I=rt,ln=In,un=zn,dn=Vn,G=rn,pn=tt,J=Bn,hn=Kn;return q(),z("div",Rt,[d("div",Nt,[d("div",Et,[r(m,{onClick:(K=e(f))==null?void 0:K.open},null,8,["onClick"])]),d("div",Dt,[Wt,r(B,{type:"success",size:"large",class:"ml-2 cursor-pointer",onClick:p[0]||(p[0]=A=>S(!0))},{default:v(()=>[L(" v"+M(e(t)),1)]),_:1})]),d("div",Ot,[r(y),r(P),r(I)])]),r(e(Ht),{ref_key:"updaterRef",ref:u},null,512),r(e(Ut),{ref_key:"startupItemsRef",ref:_},null,512),r(e(Bt),{ref_key:"changelogRef",ref:f},null,512),d("div",Gt,[r(G,null,{default:v(()=>[r(e(D),{onClick:k},{default:v(()=>[L(M(e(o)("install ca")),1)]),_:1}),r(ln),d("div",Jt,[d("span",Kt,M(e(o)("proxy port")),1),r(un,{value:e(x),"onUpdate:value":p[1]||(p[1]=A=>R(x)?x.value=A:null),"allow-input":g,class:"w-20!"},null,8,["value"])]),d("div",Qt,[d("span",Xt,M(e(o)("proxy start")),1),r(dn,{value:e(w),onUpdateValue:b},null,8,["value"])])]),_:1})]),d("div",Yt,[r(G,null,{default:v(()=>{var A;return[r(J,{text:e(o)("startup items"),onClick:(A=e(_))==null?void 0:A.show},{default:v(()=>[r(pn)]),_:1},8,["text","onClick"]),r(J,{text:e(o)("launch"),onClick:j},{default:v(()=>[r(hn)]),_:1},8,["text"])]}),_:1})])])}}});export{fe as default};
