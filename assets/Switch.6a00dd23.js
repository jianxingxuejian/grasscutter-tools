import{a,t as n,v as t,d as O,e as G,bw as ce,h as i,bv as M,b as s,w as E,u as L,bq as ue,r as U,A as he,g as F,i as be,b2 as j,aU as g,c5 as fe,aR as v,ak as A,ah as l,bx as pe,aV as me,B as H}from"./index.70e151a2.js";import{u as ge}from"./Tooltip.eba157d8.js";const ve=a("input-group",`
 display: inline-flex;
 width: 100%;
 flex-wrap: nowrap;
...
`,[t("children-placeholder",`
 ...
 cursor: not-allowed;
 opacity: .5;
 `)])]),ye=Object.assign(Object.assign({},L.props),{size:{type:String,default:"medium"},value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},railStyle:Function,rubberBand:{type:Boolean,default:!0},onChange:[Function,Array]});let S;const Se=O({name:"Switch",props:ye,setup(e){S===void 0&&(typeof CSS<"u"?typeof CSS.supports<"u"?S=CSS.supports("width","max(1px)"):S=!1:S=!0);const{mergedClsPrefixRef:f,inlineThemeDisabled:y}=G(e),P=L("Switch","-switch",xe,fe,e,f),d=ue(e),{mergedSizeRef:C,mergedDisabledRef:p}=d,k=U(e.defaultValue),R=he(e,"value"),m=ge(R,k),_=F(()=>m.value===e.checkedValue),w=U(!1),o=U(!1),c=F(()=>{const{railStyle:r}=e;if(!!r)return r({focused:o.value,checked:_.value})});function u(r){const{"onUpdate:value":B,onChange:V,onUpdateValue:z}=e,{nTriggerFormInput:T,nTriggerFormChange:W}=d;B&&H(B,r),z&&H(z,r),V&&H(V,r),k.value=r,T(),W()}function X(){const{nTriggerFormFocus:r}=d;r()}function Y(){const{nTriggerFormBlur:r}=d;r()}function q(){e.loading||p.value||(m.value!==e.checkedValue?u(e.checkedValue):u(e.uncheckedValue))}function J(){o.value=!0,X()}function Q(){o.value=!1,Y(),w.value=!1}function Z(r){e.loading||p.value||r.key===" "&&(m.value!==e.checkedValue?u(e.checkedValue):u(e.uncheckedValue),w.value=!1)}function ee(r){e.loading||p.value||r.key===" "&&(r.preventDefault(),w.value=!0)}const I=F(()=>{const{value:r}=C,{self:{opacityDisabled:B,railColor:V,railColorActive:z,buttonBoxShadow:T,buttonColor:W,boxShadowFocus:te,loadingColor:re,textColor:oe,iconColor:ie,[v("buttonHeight",r)]:h,[v("buttonWidth",r)]:ae,[v("buttonWidthPressed",r)]:ne,[v("railHeight",r)]:b,[v("railWidth",r)]:$,[v("railBorderRadius",r)]:se,[v("buttonBorderRadius",r)]:le},common:{cubicBezierEaseInOut:de}}=P.value;let D,K,N;return S?(D=`calc((${b} - ${h}) / 2)`,K=`max(${b}, ${h})`,N=`max(${$}, calc(${$} + ${h} - ${b}))`):(D=A((l(b)-l(h))/2),K=A(Math.max(l(b),l(h))),N=l(b)>l(h)?$:A(l($)+l(h)-l(b))),{"--n-bezier":de,"--n-button-border-radius":le,"--n-button-box-shadow":T,"--n-button-color":W,"--n-button-width":ae,"--n-button-width-pressed":ne,"--n-button-height":h,"--n-height":K,"--n-offset":D,"--n-opacity-disabled":B,"--n-rail-border-radius":se,"--n-rail-color":V,"--n-rail-color-active":z,"--n-rail-height":b,"--n-rail-width":$,"--n-width":N,"--n-box-shadow-focus":te,"--n-loading-color":re,"--n-text-color":oe,"--n-icon-color":ie}}),x=y?be("switch",F(()=>C.value[0]),I,e):void 0;return{handleClick:q,handleBlur:Q,handleFocus:J,handleKeyup:Z,handleKeydown:ee,mergedRailStyle:c,pressed:w,mergedClsPrefix:f,mergedValue:m,checked:_,mergedDisabled:p,cssVars:y?void 0:I,themeClass:x==null?void 0:x.themeClass,onRender:x==null?void 0:x.onRender}},render(){const{mergedClsPrefix:e,mergedDisabled:f,checked:y,mergedRailStyle:P,onRender:d,$slots:C}=this;d==null||d();const{checked:p,unchecked:k,icon:R,"checked-icon":m,"unchecked-icon":_}=C,w=!(j(R)&&j(m)&&j(_));return i("div",{role:"switch","aria-checked":y,class:[`${e}-switch`,this.themeClass,w&&`${e}-switch--icon`,y&&`${e}-switch--active`,f&&`${e}-switch--disabled`,this.round&&`${e}-switch--round`,this.loading&&`${e}-switch--loading`,this.pressed&&`${e}-switch--pressed`,this.rubberBand&&`${e}-switch--rubber-band`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},i("div",{class:`${e}-switch__rail`,"aria-hidden":"true",style:P},g(p,o=>g(k,c=>o||c?i("div",{"aria-hidden":!0,class:`${e}-switch__children-placeholder`},i("div",{class:`${e}-switch__rail-placeholder`},i("div",{class:`${e}-switch__button-placeholder`}),o),i("div",{class:`${e}-switch__rail-placeholder`},i("div",{class:`${e}-switch__button-placeholder`}),c)):null)),i("div",{class:`${e}-switch__button`},g(R,o=>g(m,c=>g(_,u=>i(pe,null,{default:()=>this.loading?i(me,{key:"loading",clsPrefix:e,strokeWidth:20}):this.checked&&(c||o)?i("div",{class:`${e}-switch__button-icon`,key:c?"checked-icon":"icon"},c||o):!this.checked&&(u||o)?i("div",{class:`${e}-switch__button-icon`,key:u?"unchecked-icon":"icon"},u||o):null})))),g(p,o=>o&&i("div",{key:"checked",class:`${e}-switch__checked`},o)),g(k,o=>o&&i("div",{key:"unchecked",class:`${e}-switch__unchecked`},o)))))}});export{$e as _,Se as a};
