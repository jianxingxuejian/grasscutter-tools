import{t as Q,a as T,b_ as hn,b as Y,d as I,e as _n,u as on,g as E,i as gn,h as S,aV as fn,T as vn,c8 as xn,ak as wn,aR as bn,C as B,D as M,E as p,V as yn,H as N,G as V,r as C,Y as an,M as G,J as v,I as l,bg as A,K as e,bs as H,c9 as cn,ca as D,b7 as R,cb as kn,cc as $n,bC as O,z as Cn,_ as qn,cd as jn,af as Sn,ce as Pn,cf as W,bh as zn,cg as An}from"./index.4d97d659.js";import{a as Bn,_ as Fn}from"./MyButton.vuevuetypescriptsetuptruelang.70a0e8ce.js";import{_ as Tn}from"./ServerInput.vuevuetypescriptsetuptruelang.9f06e833.js";import{_ as Un,a as In,b as Vn}from"./logo-github.988ae7eb.js";import{r as Rn,a as Z,s as Ln,_ as Mn,i as Nn,b as nn,p as tn,c as en}from"./SelectFile.vuevuetypescriptsetuptruelang.8793202a.js";import{_ as Gn}from"./Checkbox.8d34fc4d.js";import{_ as Hn}from"./plugin-vueexport-helper.2444895f.js";import{a as En}from"./Tooltip.bc473fd6.js";import{_ as rn}from"./Space.e584974f.js";import{_ as Wn}from"./Tag.c1dbfae9.js";import{a as Zn}from"./Switch.d307875a.js";import"./axios.5cbd07a8.js";import"./Dropdown.002c731a.js";import"./ChevronRight.6d920f51.js";import"./InputGroupLabel.853035fa.js";import"./Popselect.35db64cb.js";import"./get-slot.8207e825.js";function On(a,i){const t=[];let r=0;for(const n of a.split(`
...
[1.4.3]: https://github.com/jianxingxuejian/grasscutter-tools/compare/v1.4.2...v1.4.3
[1.4.2]: https://github.com/jianxingxuejian/grasscutter-tools/releases/tag/v1.4.2
`,ft={class:"flex-col items-center"},vt={class:"text-8"},xt=p("div",{id:"content"},null,-1),wt=I({__name:"Changelog",setup(a,{expose:i}){i({open:m});const{t}=N(),r=V(),n=C(!1);function m(){n.value=!0,an(()=>{const s=document.getElementById("content");if(!s)return;let u;r.locale==="zh-CN"?u=_t:u=gt,s.innerHTML=L(On(u))})}return(s,u)=>{const d=cn,h=D;return B(),G(h,{show:e(n),"onUpdate:show":u[0]||(u[0]=x=>H(n)?n.value=x:null),class:"w-40% of-auto"},{default:v(()=>[l(d,{class:"h-80vh"},{default:v(()=>[p("div",ft,[p("div",vt,A(e(t)("changelog")),1),xt])]),_:1})]),_:1},8,["show"])}}});const bt={class:"flex-col items-center gap-y-5"},yt={class:"flex-center w-full"},kt={class:"flex-center w-full"},$t={class:"flex-center w-full"},Ct={class:"flex-center w-full"},qt=I({__name:"StartupItems",setup(a,{expose:i}){i({show:b,launcherAll:_});const{t}=N(),r=V(),{launcher:n,mod:m,updateGamePath:s,updateModPath:u,updateAkebiPath:d,updateLauncher:h,updateGCPath:x}=r,w=C(!1);function b(){w.value=!0}const y=()=>F(x),f=()=>F(s),q=()=>F(u),P=()=>F(d);async function F(c){const o=await Ln();o&&await c(o)}async function _(){var c;try{const o=n.GCPath;o&&n.GCStart&&await Rn(o);const k=m.path;k&&n.modStart&&await Z(k);const $=n.akebiPath;if($&&n.akebiStart)await Z($);else{const j=n.gamePath;j&&n.gameStart&&await Z(j)}}catch(o){(c=window.$message)==null||c.error(o)}}return(c,o)=>{const k=Gn,$=Mn,j=D;return B(),G(j,{show:e(w),"onUpdate:show":o[4]||(o[4]=g=>H(w)?w.value=g:null),preset:"card",title:e(t)("startup items"),"auto-focus":!1,class:"w-70%"},{default:v(()=>[p("div",bt,[p("div",yt,[l(k,{checked:e(n).GCStart,"onUpdate:checked":[o[0]||(o[0]=g=>e(n).GCStart=g),e(h)],class:"w-7 mr-4"},null,8,["checked","onUpdate:checked"]),l($,{value:e(n).GCPath,"button-text":e(t)("select"),placeholder:e(t)("select gc"),onClick:y},null,8,["value","button-text","placeholder"])]),p("div",kt,[l(k,{checked:e(n).gameStart,"onUpdate:checked":[o[1]||(o[1]=g=>e(n).gameStart=g),e(h)],class:"w-7 mr-4"},null,8,["checked","onUpdate:checked"]),l($,{value:e(n).gamePath,"button-text":e(t)("select"),placeholder:e(t)("select game"),onClick:f},null,8,["value","button-text","placeholder"])]),p("div",$t,[l(k,{checked:e(n).modStart,"onUpdate:checked":[o[2]||(o[2]=g=>e(n).modStart=g),e(h)],class:"w-7 mr-4"},null,8,["checked","onUpdate:checked"]),l($,{value:e(m).path,"button-text":e(t)("select"),placeholder:e(t)("select 3dm"),onClick:q},null,8,["value","button-text","placeholder"])]),p("div",Ct,[l(k,{checked:e(n).akebiStart,"onUpdate:checked":[o[3]||(o[3]=g=>e(n).akebiStart=g),e(h)],class:"w-7 mr-4"},null,8,["checked","onUpdate:checked"]),l($,{value:e(n).akebiPath,"button-text":e(t)("select"),placeholder:e(t)("select akebi"),onClick:P},null,8,["value","button-text","placeholder"])])])]),_:1},8,["show","title"])}}});const jt=Hn(qt,[["__scopeId","data-v-4c07da3e"]]),St={class:"flex-col items-center"},Pt={class:"text-5"},zt=p("div",{id:"content"},null,-1),At=I({__name:"Updater",setup(a,{expose:i}){i({open:s});const{t}=N(),r=C(!1),n=C(!1);async function m(){var u,d;try{r.value=!0,await kn(),(u=window.$dialog)==null||u.success({title:t("install successful"),content:t("whether relaunch"),negativeText:t("cancel"),positiveText:t("relaunch"),onPositiveClick:()=>$n()})}catch(h){(d=window.$notification)==null||d.error({title:t("failed to update"),description:`error: ${h}`,content:t("try again")})}finally{r.value=!1}}function s(u){!u||(n.value=!0,an(()=>{const d=document.getElementById("content");!d||(d.innerHTML=L(u))}))}return(u,d)=>{const h=O,x=rn,w=Xn,b=cn,y=D;return B(),G(y,{show:e(n),"onUpdate:show":d[1]||(d[1]=f=>H(n)?n.value=f:null),"mask-closable":!1,class:"w-50%"},{default:v(()=>[l(b,null,{default:v(()=>[l(w,{show:e(r)},{default:v(()=>[p("div",St,[p("div",Pt,A(e(t)("new ver discover")),1),zt,l(x,{class:"flex-center mt-4"},{default:v(()=>[l(h,{onClick:d[0]||(d[0]=f=>n.value=!1)},{default:v(()=>[R(A(e(t)("cancel")),1)]),_:1}),l(h,{type:"success",onClick:m},{default:v(()=>[R(A(e(t)("update")),1)]),_:1})]),_:1})])]),_:1},8,["show"])]),_:1})]),_:1},8,["show"])}}});const Bt={class:"flex-col px-10 gap-y-4"},Ft={class:"flex items-center"},Tt={class:"text-8"},Ut={class:"flex-center grow"},It=p("span",{class:"text-8 flex-center"},"Grasscutter-Tools",-1),Vt={class:"ml-auto flex text-8 gap-x-2 cursor-pointer"},Rt={class:"flex-center"},Lt={class:"flex"},Mt={class:"text-5 mr-2"},Nt={class:"flex"},Gt={class:"text-5 mr-2"},Ht={class:"flex-center"},ce=I({__name:"index",setup(a){const{t:i}=N(),t=C(""),r=C(!1),n=C(),m=V(),{updateCheckTime:s,getServer:u}=V(),d=C(),h=C(),x=C();async function w(){var _,c;try{const o=await Nn();(_=window.$message)==null||_.success(o)}catch(o){(c=window.$message)==null||c.error(o)}}const b=C("8080"),y=C(!1);function f(_){if(!/^\d+$/.test(_))return!1;const c=Number(_);return c>0&&c<=65535}async function q(_){var c;try{_?(await nn(u),await tn(b.value),y.value=!0):(await en(),y.value=!1)}catch(o){(c=window.$message)==null||c.error(o)}}async function P(){var _;await nn(u),await tn(b.value),y.value=!0,(_=h.value)==null||_.launcherAll()}async function F(_){var k,$;const c=Date.now(),o=m.update.lastCheckTime;if(_||!o||o&&o+216e5<c)try{const{shouldUpdate:j,manifest:g}=await An();j&&(g==null?void 0:g.body)?(n.value=JSON.parse(g.body)[m.locale],r.value=!0):(k=window.$message)==null||k.success(i("latest ver now"))}catch(j){($=window.$notification)==null||$.error({title:i("failed get update info"),description:`error: ${j}`,content:i("retry manually")})}finally{s(c)}}return Cn(()=>{var _;if(r.value){const c=(_=window.$notification)==null?void 0:_.info({title:i("new ver discover"),content:i("whether upgrade"),action:()=>S(O,{text:!0,type:"primary",onClick:()=>{var o;c==null||c.destroy(),(o=d.value)==null||o.open(n.value)}},{default:()=>i("confirm")})})}}),qn(async()=>t.value=await jn()),Sn(async()=>F()),Pn(window,"beforeunload",()=>{y.value&&en()}),(_,c)=>{var X;const o=mt,k=Wn,$=Un,j=In,g=Vn,ln=Tn,un=Bn,dn=Zn,J=rn,pn=ct,K=Fn,mn=et;return B(),M("div",Bt,[p("div",Ft,[p("div",Tt,[l(o,{class:"cursor-pointer",onClick:(X=e(x))==null?void 0:X.open},null,8,["onClick"])]),p("div",Ut,[It,l(k,{type:"success",size:"large",class:"ml-2 cursor-pointer",onClick:c[0]||(c[0]=z=>F(!0))},{default:v(()=>[R(" v"+A(e(t)),1)]),_:1})]),p("div",Vt,[l($,{onClick:c[1]||(c[1]=z=>e(W)("https://github.com/jianxingxuejian/grasscutter-tools"))}),l(j,{onClick:c[2]||(c[2]=z=>e(W)("https://discord.com/invite/qGyWhAUApU"))}),e(m).locale==="zh-CN"?(B(),G(g,{key:0,onClick:c[3]||(c[3]=z=>e(W)("https://qm.qq.com/cgi-bin/qm/qr?k=0VnTLjWPz76RSScycDyp2_X68w6b73gO&jump_from=webapi&authKey=AO4rT4mzAw8krhEVDIMECCwFX7wRmGJA9+ui7AK7aQRA3l5BCeS1h/3pXT2MCkzZ"))})):zn("v-if",!0)])]),l(e(At),{ref_key:"updaterRef",ref:d},null,512),l(e(jt),{ref_key:"startupItemsRef",ref:h},null,512),l(e(wt),{ref_key:"changelogRef",ref:x},null,512),p("div",Rt,[l(J,null,{default:v(()=>[l(e(O),{onClick:w},{default:v(()=>[R(A(e(i)("install ca")),1)]),_:1}),l(ln),p("div",Lt,[p("span",Mt,A(e(i)("proxy port")),1),l(un,{value:e(b),"onUpdate:value":c[4]||(c[4]=z=>H(b)?b.value=z:null),"allow-input":f,class:"w-20!"},null,8,["value"])]),p("div",Nt,[p("span",Gt,A(e(i)("proxy start")),1),l(dn,{value:e(y),onUpdateValue:q},null,8,["value"])])]),_:1})]),p("div",Ht,[l(J,null,{default:v(()=>{var z;return[l(K,{text:e(i)("startup items"),onClick:(z=e(h))==null?void 0:z.show},{default:v(()=>[l(pn)]),_:1},8,["text","onClick"]),l(K,{text:e(i)("launch"),onClick:P},{default:v(()=>[l(mn)]),_:1},8,["text"])]}),_:1})])])}}});export{ce as default};
